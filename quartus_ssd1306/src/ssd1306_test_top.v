...
//
// KEY1 (key_start) → static test pattern (single frame)
// KEY2 (key_anim)  → animated spotlight sweep (press again to stop)
//
// LEDs (active-high):
...
//   Digits 3-1: byte counter (hex)
//   Digit 0: status indicator
// ---------------------------------------------------------------------------
module ssd1306_test_top (
    ...
    ssd1306_ctrl #(
        ...
        .clk_i            (clk_50m),
        .rstn_i           (rst_n),
        .start_i          (key_start_pulse),
        .anim_i           (key_anim_pulse),
        .busy_o           (ssd_busy),
        .done_o           (ssd_done),
        .err_o            (ssd_err),
